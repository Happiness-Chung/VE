...
# Grounding DINO
import GroundedSAM.GroundingDINO.groundingdino.transforms as T
...
if __name__ == "__main__":
    ...
    parser.add_argument("-t", "--text_prompt", type=str, default="Please segment the person in the middle", required=False, help="text prompt")
