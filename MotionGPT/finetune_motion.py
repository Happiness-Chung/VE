...
max_iters = 200000 * 3 // args.micro_batch_size
...
def main():
    ...
    tokenizer = Tokenizer("./checkpoints/lit-llama/7B/tokenizer.model")
    ...
    fabric.save(os.path.join(args.out_dir, "lit-llama-lora-finetuned2.pth"), checkpoint)
